...
def main(request_type_class):
    ...
    services = ['ts-assurance-mongo', 'ts-security-mongo', 'ts-consign-price-mongo', 'ts-consign-mongo', 'ts-order-mongo', 'ts-food-mongo', 'ts-food-map-mongo', 'ts-train-mongo', 'ts-station-mongo', 'ts-config-mongo', 'ts-inside-payment-mongo', 'ts-ticket-office-mongo', 'ts-travel-mongo', 'ts-user-mongo', 'ts-price-mongo', 'ts-travel2-mongo', 'ts-order-other-mongo', 'ts-payment-mongo', 'ts-voucher-mysql', 'ts-route-mongo', 'ts-contacts-mongo', 'ts-auth-mongo', 
    'ts-user-service', 'ts-auth-service', 'ts-inside-payment-service', 'ts-preserve-other-service', 'ts-rebook-service', 'ts-route-service', 'ts-ticketinfo-service', 'ts-admin-travel-service', 'ts-food-map-service', 'ts-train-service', 'ts-admin-user-service', 'ts-cancel-service', 'ts-ticket-office-service', 'ts-station-service', 'ts-travel-service', 'ts-execute-service', 'ts-preserve-service', 'ts-payment-service', 'ts-contacts-service', 'ts-basic-service', 
